...
.. image:: _static/spark_python_template_logo.png
   :align: center
   :width: 400px
...
.. image:: https://img.shields.io/github/repo-size/spark-csd/spark_python_template.svg
        :target: https://github.com/spark-csd/spark_python_template.zip

.. image:: https://img.shields.io/github/issues/spark-csd/spark_python_template.svg
        :target: https://github.com/spark-csd/spark_python_template/issues

.. image:: https://img.shields.io/github/issues-pr/spark-csd/spark_python_template.svg
        :target: https://github.com/spark-csd/spark_python_template/pulls
...
``spark_python_template`` aims to provide a set of tools for ADD description here. 
...
the :ref:`api_ref` or ask a question on `GitHub <https://github.com/spark-csd/spark_python_template/issues>`_.
